...
public class Homepage extends Reporting {
	...
	public void Searchbox() throws InterruptedException {
		...
		test = extent.createTest("Verify search by user entered keyword");
			...
			System.out.println("The placeholder value is expected, ie : "+PlaceText);
			
			error=PlaceText;
			Assert.assertEquals("Search", PlaceText);
	}

	// @Test(priority = 5, description = "Homepage>>Test Case No.5 Verify Search by
	// Keywords Suggestion")
	...
	// @Test(priority = 6, description = "Homepage>>Test Case No.6>>Verify the
	// sorting Options from Low to High on Search Page")
	...
	// @Test(priority = 7, description = "Homepage>>Test Case No.7>> Verify the
	// sorting Options from High to Low on Search Page")
	...
	// @Test(priority = 8, description = "Homepage>>Test Case No.8>>Verify the
	...
	// @Test(priority =9, description = "Homepage>>Test Case No.9>>Verify User
	// Navigation to wishlist as Guest")
	public void wishlist_Guest_User() throws InterruptedException {
		...
		try {
			...
			test.log(Status.FAIL, MarkupHelper.createLabel("Login pop-up not displayed on clicking Wishlist as Guest",
					ExtentColor.RED));
		}

	}

	// @Test(priority = 10, description = "Homepage>>Test Case No.10>>Verify User
	// Navigation to wishlist as Logged In")
	public void wishlist_loggedIn() throws InterruptedException {
		...
		try {
			...
			test.log(Status.FAIL,
					MarkupHelper.createLabel("Wishlist Page not displayed for Logged In User", ExtentColor.RED));
		}

	}

	// @Test(priority = 11, description="Homepage>>Test Case No.11>>Verifying Top
	// Brands")
	...
	// @Test(priority = 12, description="Homepage>>Test Case No.12>> Verify Editor's
	// Pick")
	public void EditorsPick() {
		...
		try {
			...
			test.log(Status.FAIL,
					MarkupHelper.createLabel("In the spotlight Carosuel is not displayed", ExtentColor.RED));
		}
	}

	// @Test(priority = 13, description="Homepage>>Test Case No.13>> Verify
	// Bestseller section")
	...
	// @Test(priority = 14, description ="Homepage>>Test Case No. 14>>Verify footer
	// links on Homepage")
	public void Footer() throws InterruptedException {
		...
		try {
			...
			WebElement footer = driver.findElement(
					By.xpath("//body/div[1]/footer[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]"));
	...
	// @Test(priority = 15, description ="Homepage>>Test Case No.15>>Verify
	...
	// @Test(priority = 16, description ="Homepage>>Test Case No.16>>Verify Social
	// sites icons and links")
	...
	// @Test(priority =17, description ="Homepage>>Test Case No. 17>>Verify Live
	// Chat icon displayed on Homepage")
	...
	// @Test(priority =18, description ="Homepage>>Test Case No. 18>>Verify Image
	// Slider and Carousal Dots displayed on Homepage")
